...
export default function CarPectLandingPage() {
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/20">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/carpect" className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-3">
            <Link href="/carpect/login" className="text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors px-3 py-1.5">
              Sign in
            </Link>
            <Link href="/carpect/register" className="inline-flex items-center gap-1.5 bg-blue-600 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-blue-700 transition-all shadow-md shadow-blue-500/25 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-px">
      ...
      <section className="mesh-bg pt-32 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/carpect/register" className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-8 py-4 rounded-2xl text-base font-semibold hover:bg-blue-500 transition-all shadow-xl shadow-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/40 hover:-translate-y-0.5">
              Start for free
              <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/carpect/demo" className="inline-flex items-center justify-center gap-2 bg-white/10 border border-white/20 text-white px-8 py-4 rounded-2xl text-base font-semibold hover:bg-white/15 transition-all backdrop-blur-sm">
            ...
            <div className="bg-gray-900/80 rounded-xl overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 bg-gray-800/60 border-b border-white/5">
                ...
                <div className="flex-1 mx-4 bg-gray-700/50 rounded-md h-6 flex items-center px-3">
                  <span className="text-gray-400 text-xs">hashai.com/carpect/dashboard</span>
                </div>
              </div>
      ...
      <section className="py-16 px-6 bg-gray-50 border-t border-gray-100">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/carpect/register" className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-8 py-3.5 rounded-xl text-sm font-semibold hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/25 hover:-translate-y-0.5">
              Start free 14-day trial
              <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/carpect/demo" className="inline-flex items-center justify-center gap-2 border-2 border-gray-200 text-gray-700 px-8 py-3.5 rounded-xl text-sm font-semibold hover:border-gray-300 hover:bg-gray-50 transition-all">
