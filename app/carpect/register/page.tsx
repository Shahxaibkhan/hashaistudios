    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10 bg-white overflow-y-auto">
        <div className="w-full max-w-sm">
          <Link href="/carpect" className="flex items-center gap-2 mb-8 lg:hidden">
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            ...
            <Link href="/carpect/login" className="text-blue-600 font-semibold hover:underline">Sign in →</Link>
          </p>
        </div>
      </div>
    </div>
