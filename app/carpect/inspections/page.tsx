  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/carpect/inspections/new" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">
      ...
      {inspections.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <Link href="/carpect/inspections/new" className="inline-flex items-center gap-2 bg-blue-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700">
              ...
              {inspections.map(insp => (
                <tr key={insp.id} className="hover:bg-gray-50 transition-colors cursor-pointer">
                  <td className="px-5 py-4">
                    <Link href={`/carpect/inspections/${insp.id}`} className="flex items-center gap-3">
