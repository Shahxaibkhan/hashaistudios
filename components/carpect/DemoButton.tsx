...
export default function CarPectDemoButton({ hasData }: { hasData: boolean }) {
  ...
  async function loadDemo() {
    setLoading(true)
    try {
      const res = await fetch('/api/carpect/demo/seed', { method: 'POST' })
  ...
  async function removeDemo() {
    setRemoving(true)
    try {
      const res = await fetch('/api/carpect/demo/seed', { method: 'DELETE' })
